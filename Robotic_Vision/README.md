...
There are four lectures in this stream, and I'm presenting all of them.  The first, lecture A0, is a general maths-free introduction to the topic of robotic vision.  

The next three lectures (A1, A2, A3) will introduce you to important foundational concepts in computer vision.  These are "classical" topics
but nevertheless topics that we strongly believe are important to understand, even in the modern deep-learning era.

There are four sets of learning resources for each of A1-3, and these are described in more detail below.
...
* [Lecture A0](#lecture-a0-introduction-to-robotic-vision): Introduction to Robotic Vision (7:30pm Sunday, 30 minutes)
* [Lecture A1](#lecture-a1-image-formation):  Image Formation (8:30am Monday, 45 minutes)
* [Lecture A2](#lecture-a2-image-processing): Image Processing (9:45am Monday, 45 minutes)
* [Lecture A3](#lecture-a3-feature-extraction): Feature Extraction (10:45am Monday, 45 minutes)
* Hands-on session (11:30am Monday, 60 minutes), chat about concepts from lectures, work through notebook examples

The PDFs of lectures A1-3 are provided in advance.  Feel free to load them into your tablet to annotate as we go along.
...
The books are quite hands on, with lots of code examples.  They are very similar in chapter structure and content, the first is based on Python code and open-source packages like OpenCV, the second is based on MATLAB and proprietrary toolboxes that you need to licence from MathWorks (most universities will provide you the required licences).  It's just a matter of personal preference.
...
You can run these online using Google CoLab with zero local installation. Convenient, but the downside is that the notebooks have a long startup time due to the need to install lots of packages.
...
I would highly recommend that you use [Miniconda](https://docs.conda.io/projects/miniconda/en/latest) and create an environment for your RVSS code.  I wouldn't recommend using Python older than 3.10
```
...
## Lecture A0: Introduction to Robotic Vision

**7:30pm Sunday, 30 minutes**
...
* <a href="https://www.dropbox.com/scl/fi/vgyo0xmokwgxufuxenuot/A1-Image-formation.pdf?rlkey=y1psm9aqb0wt6mi0yu5xox3q7&dl=0" target="_blank">Lecture PDF file</a>
...
* <a href="https://www.dropbox.com/scl/fi/dbawm2htd2th7dz38tvx9/A2-Image-processing.pdf?rlkey=lvefgrygbn5dzp08eeh3tdw4m&dl=0" target="_blank">Lecture PDF file</a>

* Robotics, Vision & Control: Chapter 11
...
* Robot Academy video masterclasses (each is a collection of short videos, ~1h total run time)
  ...
  * [3D vision](https://robotacademy.net.au/masterclass/3d-vision/) only watch parts 1 and 4.
...
* Robotics, Vision & Control: Chapter 12
